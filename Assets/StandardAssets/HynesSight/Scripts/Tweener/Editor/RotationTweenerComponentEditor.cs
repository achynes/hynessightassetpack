...
{
	[CustomEditor(typeof(RotationTweenerComponent))][CanEditMultipleObjects]
	public sealed class RotationTweenerComponentEditor : TweenerComponentEditor_Base
	{
		...
		protected override void OnEnable()
		{
			...
			_localRotation = serializedObject.FindProperty("_localRotation");
		...
		public override void OnInspectorGUI()
		{
			...
			label = new GUIContent("Local Rotation:");
			EditorGUILayout.PropertyField(_localRotation, label);
